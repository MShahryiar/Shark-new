...
const Banner = () => {
  return (
    <div className='flex flex-col md:flex-row p-10 px-5 md:px-20 justify-around  h-fit md:h-screen '>
        <div className='flex-1  grid grid-rows-1 max-md:mb-10 md:grid-rows-4'>
            ...
            <h1 className='text-2xl md:text-6xl text-primary  font-semibold    capitalize'>Turning Your <span className='text-secondary'>Canadian Dream</span> into Reality with Expert Guidance.</h1>
        ...
        <div className='flex-1 flex items-center  justify-center'>
            <img src={"./images/about.jpg"} alt='Banner image ' className='rounded-md h-96 md:h-5/6 object-cover'/>
        </div>
    </div>
  )
}
