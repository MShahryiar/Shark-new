...
const CTA = () => {
  ...
  return (
    <div className='md:w-5/6 w-fit   my-20 mx-auto h-fit  '>
        <div className='p-4 md:p-10 bg-[#e63946] h-full mx-auto rounded-3xl flex lg:flex-row gap-5 flex-col   items-center justify-between '>
          <div className='flex flex-col gap-2 md:text-left text-center' >
            ...
            <p className='max-w-2xs md:text-left md:max-w-full text-center text-gray-50 text-lg md:text-xl'>The perfect destination to begin a new life...</p>
          </div>
          <button
