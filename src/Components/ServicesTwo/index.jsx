  ...
  return (
    <div className='h-fit md:h-[500px] grid grid-cols-1 md:grid-cols-3'>
        <div className='grid-cols-1 p-20 md:p-10 bg-secondary opacity-80   flex flex-col justify-center items-center'>
            ...
            <button className='border-2 border-white  px-5 py-3 text-white hover:text-blue-900 hover:bg-white duration-500 rounded-md cursor-pointer'>Inquire Now</button>
            </div>
        </div>
        <div className='col-span-2 p-20 md:p-10    flex flex-col justify-center items-center relative'>
            ...
            <button className='flex gap-5 items-center font-bold text-sm text-white group'>Read More <MoveRight className='text-white size-4 group-hover:translate-x-2  group-hover:text-red-500 duration-500'/> </button>
            </div>
        </div>
